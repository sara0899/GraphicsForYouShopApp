        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Graphics_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Graphics_Collections_CollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GraphicPictures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GraphicPictures_Graphics_GraphicId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Promotions_Graphics_GraphicId",
                        column: x => x.GraphicId,
                        principalTable: "Graphics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GraphicFile = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => new { x.OrderId, x.GraphicId });
                    table.ForeignKey(
                        name: "FK_OrderItems_Graphics_GraphicId",
                        column: x => x.GraphicId,
                        principalTable: "Graphics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GraphicPictures_GraphicId",
                table: "GraphicPictures",
                column: "GraphicId");

            migrationBuilder.CreateIndex(
                name: "IX_Graphics_CategoryId",
                table: "Graphics",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Graphics_CollectionId",
                table: "Graphics",
                column: "CollectionId");
